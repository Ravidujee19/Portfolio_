        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              Hi, I'm Ravidu Wickramaarachchi, a Data Science undergraduate at SLIIT with a passion 
              for Artificial Intelligence, Machine Learning, Data Analytics, and Data Engineering. 
              I love turning complex datasets into actionable insights and building intelligent systems 
              that solve real-world problems.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              With a strong background in web development, I've built numerous web applications and 
              mobile apps before diving deep into data science. I'm experienced in Python, SQL, ML/DL 
              frameworks (TensorFlow, PyTorch, Scikit-learn), and visualization tools like Power BI and 
              Streamlit. My projects range from multi-agent AI systems and predictive ML pipelines to 
              interactive dashboards, web applications, mobile apps, and exploratory data analysis, 
              all aimed at creating meaningful impact.
            </p>
            <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
              I thrive on hands-on learning, collaboration, and experimenting with cutting-edge AI techniques, 
              constantly exploring new ways to leverage data and technology to make smarter decisions.
            </p>
